Shader "toshi/VLiveKit/Test/HDRP Lit Feature/Full Lit Forward"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #define VLIVEKIT_LIGHT_FEATURE_FLAGS (LIGHT_FEATURE_MASK_FLAGS_OPAQUE | MATERIALFEATUREFLAGS_LIT_STANDARD)
