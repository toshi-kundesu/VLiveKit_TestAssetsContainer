Shader "toshi/VLiveKit/Test/HDRP Lit Feature/Point Light Receive"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #define VLIVEKIT_LIGHT_FEATURE_FLAGS (LIGHTFEATUREFLAGS_PUNCTUAL | MATERIALFEATUREFLAGS_LIT_STANDARD)
